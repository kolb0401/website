...
/***/ function(module, exports, __webpack_require__) {
	...
	/** @jsx React.DOM */var $ = __webpack_require__(1);
	var Backbone = __webpack_require__(7);
	$(document).foundation();
	var offCanvasMenuComponent = __webpack_require__(3);
	var Router = __webpack_require__(4);
	var appRouter = new Router();
	var Index = __webpack_require__(5);
	var NotFound = __webpack_require__(6);
	var React = __webpack_require__(2);

	appRouter.on('route:home', function () {
	  React.render(React.createElement(Index, null), document.getElementById('page-content'));
	});

	appRouter.on('route:notFound', function (){
	  React.render(React.createElement(NotFound, null), document.getElementById('page-content'));
	});
	  ...
	  render: function () {
	    return (
	      React.createElement("section", {className: "index-page"}, 
	        React.createElement("div", {className: "main-section container"}, 
	            React.createElement("h1", {className: "title"}, "Hi I'm Jonathan"), 
	            React.createElement("p", {className: "content"}, "This is the start of my website." + ' ' +
	              "See the ", React.createElement("a", {href: "http://blog.jonathankolb.com"}, "blog"), " for updates"
	            )
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	var notFound = React.createClass({displayName: "notFound",
	  ...
	  render: function () {
	    return (
	      React.createElement("section", {className: "404-page"}, 
	        React.createElement("div", {className: "main-section container"}, 
	            React.createElement("h1", {className: "title"}, "Hi I'm Jonathan"), 
	            React.createElement("p", {className: "content"}, "This is a 404 page...")
	        )
	      )
	    );
	  },
